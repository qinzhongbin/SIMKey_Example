...
#define QCard_AUTHKEYERR        0xF4000020  /* 认证密钥错误 */
#define QCard_TIMESTAMPERR       0xF4000021  /* 时间戳错误 */
#define QCard_HMACERR               0xF4000022  /* HMAC错误 */
#define QCard_DATADECERR          0xF4000023  /* 数据解密错误 */
