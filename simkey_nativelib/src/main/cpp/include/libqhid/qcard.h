...
* Return         : 成功返回0
*******************************************************************************/
int QCard_SetNetNegotiatePar(char* remoteip,unsigned int remoteport,int negotiatemode,char* appname,char*conname,char*pin,char *poolid);
...
* Return         : 成功返回0,其它返回错误码
*******************************************************************************/
int QCard_GetKeyFromKeyPool(char* poolid,unsigned char* key,char* sequence);
